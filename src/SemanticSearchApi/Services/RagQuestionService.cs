...
public class RagQuestionService(
    ...
    DocumentVectorSearchWithHydeService vectorSearchWithHyde,
...
";
    ...
    public async Task<string> AnswerQuestWithHyde(string question)
    {
        var searchResults = await vectorSearchWithHyde.SearchAsync(question, topK: 10, includeEmbedding: false);
